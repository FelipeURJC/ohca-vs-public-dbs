...
load('../data/Paired_bootstrap_4_public_db.mat', 'alg');
results{1} = alg;
load('../data/Paired_bootstrap_4_ohca_db.mat', 'alg');
results{2} = alg;
load('../data/Paired_bootstrap_8_public_db.mat', 'alg');
results{3} = alg;
load('../data/Paired_bootstrap_8_ohca_db.mat', 'alg');
results{4} = alg;
